...
- [ ] 建立 Core、CLI、主题和插件的兼容版本矩阵与迁移说明。
- [ ] 为能力缺失、布局缺失、运行时模块冲突提供稳定的诊断格式。

### P0：真实站点与浏览器验收

- [x] 使用 tarball 验证最小博客、独立博客和独立文档消费者。
- [x] 将独立博客消费者接入发布 CI，缺少真实内容仓库时阻断检查。
- [ ] 增加首页、文章、搜索、标签、分类、归档和子路径部署的浏览器级验收。

### P1：开发者体验与采用入口

- [ ] 提供博客站和文档站的 CLI 初始化模板。
- [ ] 提供第三方插件与主题 starter，并补充最小可运行示例。
- [ ] 统一首次构建、配置错误和能力缺失时的错误提示。
