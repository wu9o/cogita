...
| 外部 JSON 内容源 | `@cogita/plugin-content-source-json` |
| 独立 Git Markdown 内容源 | `@cogita/plugin-content-source-git` |
...
- 做知识库：安装 `@cogita/theme-knowledge`，按需配置 `posts`、`contentDir` 和内容源适配器。
