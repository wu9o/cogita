...
- 41a83c6: 为带有正文读取器的外部内容源自动生成静态 Markdown 页面。
...
- 1e44a1c: 发布 Core 的运行时默认虚拟模块与插件注册契约修复，确保主题在独立项目中安装后也能安全消费可选插件数据。
...
- Updated dependencies [77e58eb]
  - @cogita/shared@0.9.1
  - @cogita/theme-editorial@0.2.5
  - @cogita/theme-lucid@0.10.5
